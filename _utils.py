...
# Input Dataset
def prepare_data(path, tokenizer=None, train=True):
    print("=== Inputting Dataset======")
    ...
    print("Preprocessing")
    dataFrame['Preprocessed_Text'] = dataFrame['SentimentText'].astype('str').apply(clean_text)
    ...
    return x_train, y_train, x_test, y_test, max_word_feature, sequence_max_len, tokenizer
